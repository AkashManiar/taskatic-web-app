...
This project is made in ReactJS, which I find is more flexible in dealing with DOM. Also react has easier learning curve, and my previous experience in React makes it easier to develop code. 
...
## What is special about Landing page?? (https://taskatic-web-app-assing-2.herokuapp.com) 

Simplicity in colors is again focused in landing page with limited use of disparate colors.  It shows 3 core functionalities of the project **Form Teams**, **Track Progress**, and **Task Management**, each one is shown with its relative icons, and has `See More`button to navigate to more details. Also footer is been attached to every page, where user can know about team of company
